...
# Specify the path to your second shell script
second_script="second_script.sh"

# Outer loop for randomwalk_speed
        ...
        for k_value in "${c2c_sigmoid_k[@]}"; do
            ...
            for x0_value in "${c2c_sigmoid_x0[@]}"; do
                ...
                for radius_value in "${c2c_radius_search[@]}"; do
                    ...
                    sbatch ./scripts/cpuN1C2_param_identification.sbatch "--randomwalk_speed $speed" "--gradient_speed$grad_speed" "--c2c_sigmoid_k $k_value" "--c2c_sigmoid_x0 $x0_value" "--c2c_radius_search $radius_value"
                done
            done
        done
    done
